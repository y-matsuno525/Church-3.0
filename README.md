# Church-3.0 (旧verは[こちら](https://github.com/y-matsuno525/Church-2.0))
## 概要
教会に属さない人のためのキリスト教系コミュニティサイト。正典が不確定であること、AIによる教義生成が特徴。
## 機能
- 聖句単位での注釈の作成、共有
- 聖句単位でのQ&A
- （未完成）複数バージョンの聖書や外典、偽書の利用 (外典・偽書の翻訳プロジェクト(テスト)は[こちら](https://github.com/y-matsuno525/translation-test))
- （未完成*）論文投稿機能
- （未完成）聖書内検索
